...
# Enumeration
We start this machine with given credentials: `olivia:ichliebedich`.
...
Warning: [Invoke-UserImpersonation] Executing LogonUser() with user: administrator\olivia
...
Inside the database, there are 3 users. We can double-click on their respective entry in order to get that user's password.
